...
class TestServiceSignaller {
 public:
  ...
  // at that time.
  int WaitForRpcsWaitingForServerToContinue(int desired_rpcs,
                                            absl::Duration timeout) {
    gpr_log(GPR_DEBUG, "*** enter WaitForRpcsWaitingForServerToContinue ***");
    ...
    gpr_log(GPR_DEBUG, "*** leave WaitForRpcsWaitingForServerToContinue ***");
...
class TestMultipleServiceImpl : public RpcService {
 public:
  ...
  int WaitForRpcsWaitingForServerToContinue(
      int desired_rpcs, absl::Duration timeout = absl::Minutes(1)) {
    return signaller_.WaitForRpcsWaitingForServerToContinue(desired_rpcs,
                                                            timeout);
  }
